...
interface TemplateSeed {
  id: string;
  /** Permanent visual variant identity; never derive appearance from array position. */
  variantSeed: number;
  name: string;
  description: string;
...
const PACKS: readonly PackDefinition[] = [
  ...
  },
  {
    ...
    templates: [
      { id: 'terracotta-teal', name: 'Terracotta & Teal', description: 'Sun-baked terracotta balanced by cool, confident teal.', tags: ['terracotta', 'teal'], paper: '#f7eadf', line: 'rgba(44, 113, 110, 0.18)', text: '#4a342d', muted: '#826c64', accent: '#277873', highlight: 'rgba(211, 116, 78, 0.38)', highlightText: '#48271c', pattern: 'scallop', font: humanist, headingFont: serif, frame: 'rounded', mood: 'playful', variantSeed: 0 },
  ...
  },
  {
    ...
    templates: [
      ...
      { id: 'mathematics-proof', name: 'Mathematics Proof', description: 'Precise monochrome grid paper for derivations and formal proofs.', tags: ['mathematics', 'proof'], paper: '#fbfbf8', line: 'rgba(46, 55, 64, 0.16)', major: 'rgba(46, 55, 64, 0.28)', text: '#22282d', muted: '#697177', accent: '#354d62', highlight: 'rgba(167, 188, 203, 0.38)', highlightText: '#233643', pattern: 'graph', font: technical, headingFont: serif, frame: 'technical', mood: 'technical', layout: 'wide', variantSeed: 3 },
  ...
  },
  {
    ...
    templates: [
      ...
      { id: 'mediterranean-diary', name: 'Mediterranean Diary', description: 'Whitewashed paper, cobalt ink, and lemon-yellow sunlight.', tags: ['mediterranean', 'diary'], paper: '#fffdf0', line: 'rgba(39, 91, 173, 0.2)', text: '#2e3d5a', muted: '#6f7890', accent: '#2d5eb1', highlight: 'rgba(239, 207, 65, 0.48)', highlightText: '#40370d', pattern: 'scallop', font: serif, frame: 'photo', mood: 'playful', variantSeed: 4 },
  ...
  },
  {
    ...
    templates: [
      ...
      { id: 'coastal-fog', name: 'Coastal Fog', description: 'Mist gray, muted blue, and spacious typography for quiet observations.', tags: ['coast', 'fog'], paper: '#edf1f0', line: 'rgba(90, 119, 127, 0.17)', text: '#344247', muted: '#748186', accent: '#5b7d86', highlight: 'rgba(175, 199, 199, 0.4)', highlightText: '#304747', pattern: 'blank', font: editorial, headingFont: serif, frame: 'rounded', mood: 'clean', layout: 'airy', variantSeed: 1 },
  ...
  },
  {
    ...
    templates: [
      ...
      { id: 'buttercup-paper', name: 'Buttercup Paper', description: 'Creamy yellow paper with warm honey and soft gray details.', tags: ['buttercup', 'yellow'], paper: '#fff9df', line: 'rgba(158, 139, 73, 0.18)', text: '#494432', muted: '#7d7867', accent: '#a88735', highlight: 'rgba(241, 210, 101, 0.48)', highlightText: '#42370e', pattern: 'cross-hatch', font: serif, frame: 'rounded', mood: 'literary', variantSeed: 5 },
